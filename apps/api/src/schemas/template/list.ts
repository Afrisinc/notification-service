...
export const templateListItem = {
  ...
  properties: {
    ...
    channel: { type: 'string', enum: ['EMAIL', 'SMS', 'IN_APP'], description: 'Notification channel' },
    ...
    createdAt: { type: 'string', format: 'date-time', description: 'When template was created' },
    updatedAt: { type: 'string', format: 'date-time', description: 'When template was last updated' },
  },
  required: ['id', 'code', 'channel', 'language', 'active', 'createdAt', 'updatedAt'],
};
