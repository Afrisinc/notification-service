...
import { executeMailServerCommand } from '../utils/mail-server-ssh';
...
export class DKIMService {
  private executeRemoteCommand(command: string): Promise<string> {
    return executeMailServerCommand(command);
  }
